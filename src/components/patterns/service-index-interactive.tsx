...
/**
 * Interactive variant of the service index. Hydrated lazily — only once
 * the section approaches the viewport. Its initial markup is byte-for-byte
 * identical to the static snapshot in service-index.tsx, so the swap is
 * invisible and causes no layout shift.
 */
export function ServiceIndexInteractive() {
